...
export default function MobileBottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 inset-x-0 z-50 bg-[#ffffff] border-t border-border pb-safe">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                highlight
                  ? "bg-[#ec2028] text-white -mt-4 border border-border shadow-block-sm p-3"
                  : active
                  ? "text-[#ec2028]"
                  : "text-[#666666]"
              )}
