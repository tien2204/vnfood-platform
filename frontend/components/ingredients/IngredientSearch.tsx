    ...
    <div ref={containerRef} className="relative w-full max-w-md">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-9 pr-10 py-2.5 rounded-xl border border-[#E8DDD4] bg-white text-sm text-[#1C1209] placeholder:text-[#B0A090] focus:outline-none focus:border-[#E85D26] focus:ring-2 focus:ring-[#E85D26]/10 transition-all"
      ...
      {open && suggestions.length > 0 && (
        <ul
          role="listbox"
          className="absolute z-50 top-full mt-1.5 w-full bg-white border border-[#E8DDD4] rounded-xl shadow-lg overflow-hidden max-h-56 overflow-y-auto"
        >
              ...
              <li key={item.name} role="option" aria-selected={already}>
                <button
                  ...
                  className={[
                    ...
                    already
                      ? "text-[#7C6A56] bg-[#F7F0E8] cursor-default"
