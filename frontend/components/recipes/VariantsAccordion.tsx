  ...
  return (
    <section className="mt-6 border-t border-border pt-6">
      <button
        ...
        className="flex items-center gap-2 text-lg font-medium w-full text-left text-foreground hover:text-primary transition-colors"
      >
            ...
            return (
              ...
              >
                ...
                <div className="p-2">
                  ...
                  {v.variant_label && (
                    <p className="text-xs text-muted-foreground mt-0.5">{v.variant_label}</p>
                  )}
                </div>
              </Link>
            );
