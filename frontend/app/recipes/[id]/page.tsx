    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 pb-28 lg:pb-6">
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-2 mb-3">
          {recipe.keyword && (
            <Badge className="bg-[var(--color-brand-pink-bg)] text-primary border-[var(--color-brand-pink)] hover:bg-[var(--color-brand-pink-bg)]">
              {recipe.keyword}
            </Badge>
          )}
          {recipe.difficulty && (
        ...
        {(recipe.is_canonical || recipe.is_manually_reviewed || recipe.variant_label) && (
          <div className="flex items-center gap-2 mb-4 flex-wrap">
            ...
            {recipe.variant_label && (
              <span className="text-sm text-muted-foreground">— {recipe.variant_label}</span>
            )}
          </div>
        )}
        ...
        {recipe.derived_from && (
          <p className="text-sm text-muted-foreground mb-4">
            Phỏng theo:{" "}
            <Link href={`/recipes/${recipe.derived_from.id}`} className="text-primary underline">
        ...
        {recipe.refinement_notes && (
          <details className="mb-4 p-3 bg-muted border border-border rounded-xl text-sm">
        ...
        {recipe.description && (
          <blockquote
            className="border-l-4 border-primary/30 pl-4 py-2 my-6 italic text-muted-foreground text-lg leading-relaxed"
            style={{ fontFamily: "var(--font-heading)" }}
          >
            {recipe.description}
          </blockquote>
